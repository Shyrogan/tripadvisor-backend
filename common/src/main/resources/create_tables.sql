...
CREATE TABLE IF NOT EXISTS chambre (
    ...
    prix           REAL                              NOT NULL,
    PRIMARY KEY (id_hotel, numero_chambre)
    );
...
CREATE TABLE IF NOT EXISTS reservation (
    ...
    debut          DATE NOT NULL,
    fin            DATE NOT NULL,
    FOREIGN KEY (id_hotel, numero_chambre) REFERENCES chambre (id_hotel, numero_chambre)
    );
CREATE INDEX IF NOT EXISTS idx_res_hotel ON reservation (id_hotel);
CREATE INDEX IF NOT EXISTS idx_res_hotel_chambre ON reservation (id_hotel, numero_chambre);
